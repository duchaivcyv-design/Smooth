...
# ===================================================================
# PART 3: PACKAGING SCRIPT CHUẨN ROOTLESS (ĐÃ XÓA THƯ MỤC VAR THỪA)
# ===================================================================
before-package::
	...
	@if [ -f BoostiPhone6s/layout/Library/PreferenceLoader/Entries/BoostiPhone6sPrefs.plist ]; then \
	    cp BoostiPhone6s/layout/Library/PreferenceLoader/Entries/BoostiPhone6sPrefs.plist .theos/_/var/jb/Library/PreferenceLoader/Entries/; \
